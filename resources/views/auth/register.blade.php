    ...
    <div class="flex h-full justify-center mt-5 pt-5">
        <div class="w-full md:w-2/3 lg:w-1/2 rounded-3xl">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                <header class="font-semibold bg-gray-100 text-center py-3 sm:py-3 sm:rounded-t-md text-2xl">
                    Register to Realstate
                </header>
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="name" type="text" class="form-input w-full @error('name')  border-red-500 @enderror text-xl my-2 w-full text-xl p-2 rounded-xl border-2 border-gray-300"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="password-confirm" type="password" class="form-input w-full text-xl my-2 w-full text-xl p-2 rounded-xl border-2 border-gray-300"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <p class="text-xl w-full text-xl text-center text-gray-700 my-6 sm:my-8">
                            {{ __('Already have an account?') }}
                            <a class="hover:text-blue-700 no-underline text-primary hover:underline" href="{{ route('login') }}">
                                {{ __('Login') }}
                            </a>
                        </p>
                    </div>
